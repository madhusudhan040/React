    ...
    return (<>
        ...
        <div className="container mt-5 w-75 text-center ">
            ...
            <div className="container px-5 pb-5">
                <img src={tabsimage} alt="tabs-image.png"
            ...
            <div className="container mt-5 w-75 text-center ">
                ...
                <div className="container mt-3 d-flex justify-content-around ">
                    ...
                    <div className="card  " style={{ width: '30%' }}>
                        <img className="card-img-top" src={cardImage01} alt="Card image"
                            style={{ width: '100%' }} />
                    ...
                    <div className="card  " style={{ width: '30%' }}>
                        <img className="card-img-top" src={cardImage02} alt="Card image"
                            style={{ width: '100%' }} />
                        <div className="card-body text-start">
                            <h4 className="card-title fs-3">How to build anything</h4>
                            <p className="card-text fs-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                    ...
                    <div className="card" style={{ width: '30%' }}>
                        <img className="card-img-top" src={cardImage03} alt="Card image"
                            style={{ width: '100%' }} />
                        <div className="card-body text-start">
                            <h4 className="card-title fs-3">How to build anything</h4>
                            <p className="card-text fs-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
